...
I've been fascinated by asemic writing systems — "nonsense writing", or marks that evoke writing without actually encoding any true text — since I was a small child. I discussed this in a couple of public lectures in 2013 — my [Eyeo Festival talk from 6'37–13'15](https://www.youtube.com/watch?v=gi6BH8qWBeg&t=397s), and (especially) my [Resonate Festival talk from 10'19–13:00](https://vimeo.com/88190418#t=10m18s). I found kindship in the artwork of Joan Miro and Bruno Munari, who devised imaginary writing systems for imaginary civilizations. 

![Miro / Munari](images/alpha_miro_munari.jpg)

In 2001, I was commissioned by PBS and Art21.org to create an interactive online artwork. In collaboration with Jonathan Feinberg and Cassidy Curtis, I developed the [*Alphabet Synthesis Machine*](http://flong.com/archive/projects/alphabet/index.html), a Java applet which allowed site visitors to create and evolve new asemic writing systems. The typefaces generated by the *Alphabet Synthesis Machine* probed "the liminal territories between familiarity and chaos, language and gesture". More than 20,000 visitors created alphabets at the site between 2001-2006. 

![Alphabet Synthesis Machine](images/alphabet_1.jpg)

Each mint of *Cytographia* has its own unique, computationally generated writing system. These pull from a common set of glyph sub-components, but combine them according to a different visual syntax for each mint.

![cyto-alpha.png](images/cyto-alpha.png)

For the most part, the *Cytographia* writing system only appears in reverse, as ["show-through"](https://mountainofink.com/blog/ink-properties#:~:text=Show%20through%2C) from the "other side of the page". A few characters appear as labels on the organism diagrams. This proved to be enough for me. 

![Cytographia Writing](images/cyto-writing.jpg)